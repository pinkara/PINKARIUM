...
[![Execute experience()](https://img.shields.io/badge/%3CExecute%20experience()%3E-7aa2f7?style=for-the-badge)](https://pinkara.github.io/PINKARIUM/index.html)
...
> [!NOTE]
> Aucune dépendance backend requise - 100% client-side.

### Lancement
```bash
# Clone le repository
git clone https://github.com/pinkara/pinkarium.git
cd pinkarium
...
> [!TIP]
> Double-cliquer sur `index.html` fonctionne aussi, mais peut causer
> des problèmes CORS avec certains modules. Préférez un serveur HTTP local.
...
> [!IMPORTANT]
> Chaque module est **autonome** et peut fonctionner indépendamment.
> Vous pouvez intégrer un seul module dans votre propre projet.
